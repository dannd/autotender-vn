...
def test_compliance_tier3_flags_brand_name(monkeypatch):
...
def test_compliance_tier3_flags_excessive_revenue_requirement(monkeypatch):
    module = ComplianceModule()
    force_tier3(monkeypatch, module)
...
def test_compliance_tier3_flags_tailored_spec(monkeypatch):
    module = ComplianceModule()
    force_tier3(monkeypatch, module)
...
def test_compliance_tier3_no_flag_for_clean_text(monkeypatch):
    module = ComplianceModule()
    force_tier3(monkeypatch, module)
...
def test_compliance_tier3_does_not_flag_negated_rule_description(monkeypatch):
